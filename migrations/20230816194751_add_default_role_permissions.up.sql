...
--- Admin
INSERT INTO role_permission(role_id, permission, environment, built_in) SELECT r.id, p.permission, '', true FROM roles r, permissions p WHERE r.name = 'Admin' AND r.role_type = 'root' AND p.permission = 'ADMIN';
INSERT INTO role_permission(role_id, permission, environment, built_in) SELECT r.id, p.permission, '', true FROM roles r, permissions p WHERE r.name = 'Editor' AND r.role_type = 'root' AND p.permission IN (
                                                                                                                                                                                         'CREATE_STRATEGY',
                                                                                                                                                                                         'CREATE_ADDON',
                                                                                                                                                                                         'READ_ADDON',
                                                                                                                                                                                         'DELETE_ADDON',
...
INSERT INTO role_permission(role_id, permission, environment, built_in) SELECT r.id, p.permission, '', true FROM roles r, permissions p WHERE r.name = 'Owner' AND r.role_type = 'project' AND p.permission IN (
                                                                                                                                                                                           'CREATE_FEATURE',
                                                                                                                                                                                           'UPDATE_FEATURE',
                                                                                                                                                                                           'DELETE_FEATURE',
                                                                                                                                                                                           'UPDATE_PROJECT',
...
INSERT INTO role_permission(role_id, permission, environment, built_in) SELECT r.id, p.permission, 'development', true FROM roles r, permissions p WHERE r.name = 'Owner' AND r.role_type = 'project' AND p.permission IN ('CREATE_FEATURE_STRATEGY', 'READ_FEATURE_STRATEGY', 'UPDATE_FEATURE_STRATEGY', 'DELETE_FEATURE_STRATEGY', 'UPDATE_FEATURE_ENVIRONMENT', 'UPDATE_FEATURE_ENVIRONMENT_VARIANTS');
INSERT INTO role_permission(role_id, permission, environment, built_in) SELECT r.id, p.permission, 'production', true FROM roles r, permissions p WHERE r.name = 'Owner' AND r.role_type = 'project' AND p.permission IN ('CREATE_FEATURE_STRATEGY', 'READ_FEATURE_STRATEGY', 'UPDATE_FEATURE_STRATEGY', 'DELETE_FEATURE_STRATEGY', 'UPDATE_FEATURE_ENVIRONMENT', 'UPDATE_FEATURE_ENVIRONMENT_VARIANTS');
INSERT INTO role_permission(role_id, permission, environment, built_in) SELECT r.id, p.permission, '', true FROM roles r, permissions p WHERE r.name = 'Member' AND r.role_type = 'project' AND p.permission IN (
                                                                                                                                                                                            'CREATE_FEATURE',
                                                                                                                                                                                            'UPDATE_FEATURE',
                                                                                                                                                                                            'DELETE_FEATURE',
                                                                                                                                                                                            'READ_FEATURE',
...
INSERT INTO role_permission(role_id, permission, environment, built_in) SELECT r.id, p.permission, 'development', true FROM roles r, permissions p WHERE r.name = 'Member' AND r.role_type = 'project' AND p.permission IN ('CREATE_FEATURE_STRATEGY', 'READ_FEATURE_STRATEGY', 'UPDATE_FEATURE_STRATEGY', 'DELETE_FEATURE_STRATEGY', 'UPDATE_FEATURE_ENVIRONMENT', 'UPDATE_FEATURE_ENVIRONMENT_VARIANTS');
INSERT INTO role_permission(role_id, permission, environment, built_in) SELECT r.id, p.permission, 'production', true FROM roles r, permissions p WHERE r.name = 'Member' AND r.role_type = 'project' AND p.permission IN ('CREATE_FEATURE_STRATEGY', 'READ_FEATURE_STRATEGY', 'UPDATE_FEATURE_STRATEGY', 'DELETE_FEATURE_STRATEGY', 'UPDATE_FEATURE_ENVIRONMENT', 'UPDATE_FEATURE_ENVIRONMENT_VARIANTS');
